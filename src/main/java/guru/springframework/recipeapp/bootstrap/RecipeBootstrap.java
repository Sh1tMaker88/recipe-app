...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if (dashSpoonUomOptional.isEmpty()) {
            throw new RuntimeException("Expected UoM is not found");
        }
        ...
        guacRecipe.getIngredients().add(new Ingredient(
                "kosher salt", new BigDecimal(".5"), teaSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient(
        ...
        guacRecipe.getIngredients().add(new Ingredient(
                "Cilantro", new BigDecimal(2), tableSpoonUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient(
                "freshly grated black pepper", new BigDecimal(2), dashUom, guacRecipe));
        guacRecipe.getIngredients().add(new Ingredient(
        ...
        tacosRecipe.setSource("Moderate recipe");
        tacosRecipe.setServings(4);
        tacosRecipe.setUrl("http://www.simplyrecipes.com/recipes/perfect_tacos/");
