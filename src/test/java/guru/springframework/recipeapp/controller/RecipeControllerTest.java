...
class RecipeControllerTest {
    ...
    @Test
    void gerRecipe_NotFoundTest() throws Exception {
    ...
    @Test
    void gerRecipe_NumberFormatTest() throws Exception {
    ...
    @Test
    void postNewRecipeForm_ValidationFailTest() throws Exception {
